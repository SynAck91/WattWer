...
WattWer 0.5.3 enthält weiterhin die automatische Migration aus älteren WattWer-Versionen.
...
WattWer 0.5.3 continues to include automatic migration from older WattWer versions.
